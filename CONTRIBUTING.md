# Contributing to Omicron controlDesign

The following is a set of guidelines to contribute to Omicron controlDesign Board and its repositories, which are hosted on the [omicronrobot Organization](https://github.com/omicronrobot) on GitHub.
...
Before raising a new issue, check [our issue list](https://github.com/omicronrobot/controlDesign/issues) to determine if it already contains the problem that you are facing.
...
```bash
git clone https://github.com/<your-username>/controlDesign.git
cd controlDesign
git remote add upstream https://github.com/omicronrobot/controlDesign.git
```
